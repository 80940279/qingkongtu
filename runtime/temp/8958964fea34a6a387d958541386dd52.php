<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/goods\goodsList.html";i:1575367282;s:76:"D:\phpStudy\PHPTutorial\WWW\tpshop\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="flexigrid">
	...
	<form action="" id="search-form2" class="navbar-form form-inline" method="post" onSubmit="return false">
      <div class="sDiv">
        <div class="sDiv2">     
		      <select name="suppliers_id" id="suppliers_id" class="select" style="visibility:hidden;">
          ...
          <select name="db_is_on_sale" id="is_on_sale" class="select">
          ...
          <thead>
            <tr>
              ...
              <th align="left" abbr="ac_id" axis="col4" class="">
                <div style="text-align: left; width: 400px;" class="" onClick="sort('goods_name');">商品名称</div>
              </th>
              <th align="center" abbr="article_show" axis="col6" class="">
                <div style="text-align: center; width: 150px;" class="" onClick="sort('goods_sn');">货号</div>
              </th>
			        <!--<th align="center" abbr="article_show" axis="col6" class="">
                <div style="text-align: center; width: 100px;" class="">供应商</div>
              </th>-->
              <th align="center" abbr="article_time" axis="col6" class="">
                <div style="text-align: center; width: 120px;" class="" onClick="sort('cat_id');">分类</div>
              </th>
              <th align="center" abbr="article_time" axis="col6" class="">
                <div style="text-align: center; width: 100px;" class="" onClick="sort('shop_price');">咕咕价格</div>
              </th>
              <th align="center" abbr="article_time" axis="col6" class="">
                <div style="text-align: center; width: 100px;" class="" onClick="sort('shop_price');">价格</div>
              </th>                 
              <!--<th align="center" abbr="article_time" axis="col6" class="">
              ...
              <th align="center" abbr="article_time" axis="col6" class="">
                <div style="text-align: center; width: 80px;" class="" onClick="sort('db_is_on_sale');">上/下架</div>
              </th>
              <th align="center" abbr="article_time" axis="col6" class="">
                <div style="text-align: center; width: 80px;" class="" onClick="sort('store_count');">库存</div>
              </th>
              <!--<th align="center" abbr="article_time" axis="col6" class="">
                <div style="text-align: center; width: 50px;" class="" onClick="sort('sort');">排序</div>
              </th>-->
              <th align="left" abbr="article_title" axis="col6" class="">
                <div style="text-align: center; width:85px;" class="">操作</div>
              </th>                     
