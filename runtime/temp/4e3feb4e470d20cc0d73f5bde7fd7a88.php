<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"./application/admin/view/system\user_center_menu.html";i:1568702273;s:76:"D:\phpStudy\PHPTutorial\WWW\tpshop\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
	...
	<script type="text/javascript">
		...
		$(document).on("click","#submit",function  () {
			$.ajax({
				...
				data: $('#menu').serialize(),
				dataType: 'json',
				url: "<?php echo U('System/user_center_menu_save'); ?>",
				success: function (data) {
					if (data.status == 1) {
						location.reload();
					} else {
