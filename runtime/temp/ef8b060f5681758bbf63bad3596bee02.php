<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:41:"./template/mobile/rainbow/user\index.html";i:1573788474;s:77:"D:\phpStudy\PHPTutorial\WWW\tpshop\template\mobile\rainbow\public\header.html";i:1568702281;s:81:"D:\phpStudy\PHPTutorial\WWW\tpshop\template\mobile\rainbow\public\footer_nav.html";i:1576812558;s:79:"D:\phpStudy\PHPTutorial\WWW\tpshop\template\mobile\rainbow\public\wx_share.html";i:1576490065;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
...
<!--<div id="h-onload" style="display:none;">-->
    <!--<style>-->
        <!--.h-onload{-->
            <!--width: 5rem;-->
            <!--height: 5rem;-->
...
<div class="z_user_vs">
    ...
    <div class="z_user_li_wrap">
        <?php if(is_array($menu_list) || $menu_list instanceof \think\Collection || $menu_list instanceof \think\Paginator): $i = 0; $__LIST__ = $menu_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;switch($menu['menu_id']): case "1": ?>
                        <div class="z_user_list border10" style="border: none">
                            ...
                            <ul>
                                <li>
                                    <a href="<?php echo U('/Mobile/Order/order_list',array('type'=>'WAITPAY')); ?>">
                                        ...
                                        <i><?php echo $user['waitPay']>=100?'99+':$user['waitPay']; ?></i>
                                        <p>待付款</p>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('/Mobile/Order/wait_receive',array('type'=>'WAITRECEIVE')); ?>">
                                        ...
                                        <i><?php echo $user['waitReceive']>=100?'99+':$user['waitReceive']; ?></i>
                                        <p>待收货</p>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Mobile/Order/comment',array('status'=>0)); ?>">
                                        ...
                                        <i><?php echo $user['uncomment_count']>=100?'99+':$user['uncomment_count']; ?></i>
                                        <p>待评价</p>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Mobile/Order/return_goods_list',array('type'=>1)); ?>">
                                        ...
                                        <i><?php echo $user['return_count']>=100?'99+':$user['return_count']; ?></i>
                                        <p>售后服务</p>
                                    </a>
                                </li>
                            </ul>
...
<script>
    $(function(){
        $('.z_user_head').css("background-color", "<?php echo $tpshop_config['basic_header_background']; ?>");
        var ua = window.navigator.userAgent.toLowerCase();
        if(ua.match(/MicroMessenger/i) == 'micromessenger'){
            $('#logout').hide();
        }
