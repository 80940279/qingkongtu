<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:48:"./application/admin/view/distribut\ajaxtree.html";i:1575690016;}*/ ?>
            ...
            <tr data-id="<?php echo $list['user_id']; ?>">
                ...
                <td align="center" class="handle">
                    <div style="text-align: center; width: 170px; max-width:250px;">
                        <a class="btn blue" href="<?php echo U('Admin/distribut/detail',array('id'=>$list['user_id'])); ?>">修改</a>
                        <a class="btn blue" href="<?php echo U('Admin/distribut/second_users',array('id'=>$list['user_id'])); ?>">查看下级会员</a>
