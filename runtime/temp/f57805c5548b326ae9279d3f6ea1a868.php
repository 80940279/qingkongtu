<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/template\change.html";i:1568702273;s:76:"D:\phpStudy\PHPTutorial\WWW\tpshop\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a href="<?php echo U('Template/change',array('t'=>'pc')); ?>" <?php if(\think\Request::instance()->param('t') != 'mobile'): ?>class="current"<?php endif; ?>><span>PC端模板</span></a></li>
                <li><a href="<?php echo U('Template/change',array('t'=>'mobile')); ?>" <?php if(\think\Request::instance()->param('t') == 'mobile'): ?>class="current"<?php endif; ?>><span>手机端模板</span></a></li>
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
                            ...
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <?php if($default_theme == $k): ?>
                                        <a href="<?php echo U('Admin/template/changeTemplate',array('key'=>$k,'t'=>$t)); ?>" class="btn blue" style="color: #FFF;background-color: #3598DC;border-color: #2A80B9;line-height: 24px;height: 24px;margin:0;">启用</a>
                                        <?php else: ?>
                                        <a href="<?php echo U('Admin/template/changeTemplate',array('key'=>$k,'t'=>$t)); ?>" class="btn blue">启用</a>
                                    <?php endif; ?>
                                </div>
                            </td>
