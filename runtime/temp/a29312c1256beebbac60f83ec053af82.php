<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view/news\categoryList.html";i:1568702273;s:76:"D:\phpStudy\PHPTutorial\WWW\tpshop\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <tr nctype="0" class="parent_id_<?php echo $vo[parent_id]; ?>" data-level="<?php echo $vo[level]; ?>"  id="<?php echo $vo['level']; ?>_<?php echo $vo['cat_id']; ?>">
              ...
              <td class="sort">
                <div style="text-align: center; width: 60px;">
                  <input type="text" onKeyUp="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" onblur="changeTableVal('news_cat','cat_id','<?php echo $vo['cat_id']; ?>','sort_order',this)" size="4" value="<?php echo $vo['sort_order']; ?>" />
                </div>
              </td>
              <td class="name">
              ...
              <td style="width: 100%;">
                <div><a href="<?php echo U('News/category',array('act'=>'edit','cat_id'=>$vo['cat_id'])); ?>">编辑</a>    
                     <a href="javascript:void(0)" data-url="<?php echo U('News/categoryHandle'); ?>" data-id="<?php echo $vo['cat_id']; ?>" onClick="delfun(this)">删除</a></div>
