<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view/promotion\flash_sale.html";i:1568702273;s:76:"D:\phpStudy\PHPTutorial\WWW\tpshop\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	<div class="fixed-bar">
		...
		<a href="http://help.tp-shop.cn/Index/Help/info/cat_id/5/id/47.html" style="display: <?php echo tpCache('basic.is_manual')?'block':'none'; ?>"  class="manual" target="_blank"><i class="fa fa-calendar"></i>抢购帮助手册</a>
	...
	<div id="explanation" class="explanation">
        <div class="bckopa-tips">
            ...
            <ul>
				...
				<li>抢购列表页可以让管理员了解活动目前状态，活动商品已购买数以及订单数等一些重要的活动数据。</li>
				<li>抢购活动删除：秒杀活动在没有订单的情况下，是可以删除的，但是一旦有客户下了订单，活动将无法删除。</li>
				<li>将秒杀活动时间设置到需要秒杀的那个时间段，前台也会同步显示到那一个时间段，当时间到达那个时间段后，会自动开始秒杀活动。</li>
            </ul>
        </div>
	...
	<div class="flexigrid">
		<div class="mDiv">
            ...
            <a href="<?php echo U('Promotion/flash_sale_info'); ?>"><div class="fbutton"><div title="添加活动" class="add"><span><i class="fa fa-plus"></i>添加活动</span></div></div></a>
            <div class="fbutton"><a href="http://help.tp-shop.cn/Index/Help/info/cat_id/5/id/47.html" target="_blank"><div class="add" title="帮助"><span>帮助</span></div></a></div>
						...
						<tr>
							...
							<td align="left" class="handle">
								<div style="text-align: left; width: 150px; max-width:170px;">
									<a class="btn blue" href="<?php echo U('Promotion/flash_sale_info',array('id'=>$vo['id'])); ?>">编辑</a>
									<a class="btn red" href="javascript:void(0)" data-url="<?php echo U('Promotion/flash_sale_del'); ?>" data-id="<?php echo $vo['id']; ?>" onClick="delfun(this)">删除</a>
								</div>
							</td>
