<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:39:"./application/admin/view/ad\adList.html";i:1568702273;s:76:"D:\phpStudy\PHPTutorial\WWW\tpshop\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div id="explanation" class="explanation">
        <div class="bckopa-tips">
            ...
            <ul>
            	<li>1.所有的广告位已经内置好, 不需要手动新增. 直接按照文档编辑即可</li>
                <li>2.只需要点击半透明广告图片即可更换广告.</li>
                <li>3.预览广告所在页面中选择更换你的广告.</li>
            </ul>
        </div>
  ...
  <div class="flexigrid">
    ...
    <div class="bDiv" style="height: auto;">
      <div id="flexigrid" cellpadding="0" cellspacing="0" border="0" data-url="<?php echo U('admin/Ad/delList'); ?>">
        <table>
          <tbody>
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
              <tr  data-id="<?php echo $vo[ad_id]; ?>">
                <td class="sign">
                  <div style="width: 24px;"><i class="ico-check"></i></div>
                </td>
                <td align="left" class="">
                ...
                <td align="center" class="">
                  <div style="text-align: center; width: 100px;"><img src="<?php echo $vo['ad_code']; ?>" width="80px" height="45px" alt=""></div>
                </td>      
                <td align="center" class="">
              ...
              <td align="center">
                ...
                <td align="center" class="handle">
                  <div style="text-align: center; width: 100px;">                    
                    <a class="btn red" onClick="delfunc(this)" data-url="<?php echo U('Ad/adHandle'); ?>" data-id="<?php echo $vo['ad_id']; ?>">删除</a>                                                            
                  </div>
                </td>
