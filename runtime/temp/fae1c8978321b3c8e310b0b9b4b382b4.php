<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:46:"./template/mobile/rainbow/goods\goodsInfo.html";i:1576492307;s:77:"D:\phpStudy\PHPTutorial\WWW\tpshop\template\mobile\rainbow\public\header.html";i:1568702281;s:78:"D:\phpStudy\PHPTutorial\WWW\tpshop\template\mobile\rainbow\public\top_nav.html";i:1576813430;s:88:"D:\phpStudy\PHPTutorial\WWW\tpshop\template\mobile\rainbow\goods\goodsInfo_template.html";i:1568702281;s:84:"D:\phpStudy\PHPTutorial\WWW\tpshop\template\mobile\rainbow\goods\goodsInfo_info.html";i:1576491816;s:79:"D:\phpStudy\PHPTutorial\WWW\tpshop\template\mobile\rainbow\public\wx_share.html";i:1576490065;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
...
<link rel="stylesheet" href="/template/mobile/rainbow/static/css/shopdes.css">
<div class="he_sustain">
    <div class="classreturn loginsignup detail">
        <div class="content">
            <div class="ds-in-bl return">
                <a href="javascript:history.go(-1);"><img src="/template/mobile/rainbow/static/images/return.png" alt="返回"></a>
            </div>
        ...
        <div class="mslide" id="slideTpshop">
            <ul>
                ...
                <?php if(is_array($goods['goods_images']) || $goods['goods_images'] instanceof \think\Collection || $goods['goods_images'] instanceof \think\Paginator): if( count($goods['goods_images'])==0 ) : echo "" ;else: foreach($goods['goods_images'] as $key=>$pic): ?>
                    <li><a href="javascript:void(0)"><img src="https://www.hetungugu.com/<?php echo $pic[image_url]; ?>" alt=""></a></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                <!--图片-e-->
            </ul>
        </div>
        <p id="kanjia_t">
            <em><?php echo $tpshop_config['shop_info_store_name']; ?>砍价购</em>
...
<div class="de_font p">
    <div class="thirty">
        ...
        <div class="book_label">
            <p class="book_price" ><b><span id="price">￥<?php echo $goods['shop_price']; ?></span></b><span>到店价<i>￥<?php echo $goods['market_price']; ?></i></span></p>
            <p class="book_peop"><span>已有<i><?php echo $goods['order_bespeak_count']+$goods['virtual_comment_count']; ?></i>人预约</span><?php echo $goods['invalid_refund']==1?"<em>过期不退</em>":"<em>随时退</em>"; ?></p>
            <!--<em>其他标签</em>-->
        </div>
        <div class="scunde p" style="display: none">
            ...
            <p>
                <?php if($goods['prom_type'] != 2): ?>销量：<span><?php echo $goods['sales_sum']+$goods['virtual_sales_sum']; ?></span><?php endif; ?>
                <span >
...
<div class="floor list7 detailsfloo">
    <div class="myorder p">
    <div class="book_storinf">
        <div class="book_storinf_item"><label>可预约时间</label><span><?php echo $goods[bespeak_template][week_day]; ?></span></div>
        <div class="book_storinf_item book_sec_item"><label>店内设施</label>
            <span>
                 <?php if(is_array($goods[bespeak_template][equipment_arr]) || $goods[bespeak_template][equipment_arr] instanceof \think\Collection || $goods[bespeak_template][equipment_arr] instanceof \think\Paginator): $i = 0; $__LIST__ = $goods[bespeak_template][equipment_arr];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$template): $mod = ($i % 2 );++$i;?>
                     <em><?php echo $template; ?></em>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </span>
        </div>
    </div>
...
<div class="de_font p">
    <div class="thirty">
        ...
        <div class="scunde p">
            <span style="margin-top:0.55rem" class="red" id="price"></span><br/>
            <div class="titlebox">
            <span><span id="market_price_title">市场价：</span><span class="linethr" id="market_price"><?php echo $goods['market_price']; ?></span></span>
            <span style="margin-top:0px;">销量：<?php echo $goods['sales_sum']+$goods['virtual_sales_sum']; ?></span>
            <?php if($goods['prom_type'] == 8): ?>
            	<span id="kanjia_store_count" >库存：<em>0</em></span>
            <?php else: ?>
				<span style="margin-left: 1.135555rem;">库存：<span class="spec_store_count"><?php echo $goods['store_count']; ?></span></span>
            <?php endif; ?>
            </div>
            <?php if($goods['give_integral'] > 0): ?>
                <p style="font-size: .5rem" class="red" >
                    赠送<span class="red" style="margin:0;font-size: .5rem"><?php echo $goods['give_integral']; ?></span>积分
                </span>
            <?php endif; ?>
        </div>
        <?php if($goods['price_ladder']): ?>
            <div class="fl"  id="price_ladder">
                <div class="ladder">
                        <?php if(is_array($goods['price_ladder']) || $goods['price_ladder'] instanceof \think\Collection || $goods['price_ladder'] instanceof \think\Paginator): if( count($goods['price_ladder'])==0 ) : echo "" ;else: foreach($goods['price_ladder'] as $key=>$item): ?>
                            <li><span><i>¥</i><?php echo $item['price']; ?></span><p>满<?php echo $item['amount']; ?>件</p></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
            </div>
        <?php endif; ?>
...
<!--领取优惠券&促销活动 end ------------------------------------------------------------------------------------------>
<!--活动-->
<?php if($goods['exchange_integral'] == 0): if(!(empty($prom_order) || (($prom_order instanceof \think\Collection || $prom_order instanceof \think\Paginator ) && $prom_order->isEmpty()))): ?>
    <div class="floor list7 detailsfloo" id="prom_order">
        <div class="myorder p ">
            <div class="content30">
                <a href="javascript:void(0)">
                    <div class="order">
                        <div class="fl">
                            <span class="firde" style="height: 1.4rem;line-height: 1.4rem;">活动</span>
                            <span class="deta-coupon1">
                                <?php if(is_array($prom_order) || $prom_order instanceof \think\Collection || $prom_order instanceof \think\Paginator): if( count($prom_order)==0 ) : echo "" ;else: foreach($prom_order as $key=>$item): ?>
                                    <div id="prom_order_<?php echo $item['id']; ?>" style="height: 1.4rem;line-height: 1.4rem;"><em><?php echo $item['name']; ?></em><span2><?php echo $item['prom_detail']; ?></span2></div>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </span>
                        </div>
                    </div>
...
<div class="floor list7 detailsfloo">
    ...
    <div style="line-height: 1.4rem;" class="myorder p">
        <div class="content30">
...
//                    地址弹出块返回按钮
    ...
    <!--运费-s-->
            ...
            <?php if($goods['is_virtual'] != 1): ?>
                <div style="line-height: 1.4rem;" class="myorder p" id="dispatching_desc">
                    <div class="content30">
                        <a class="remain" href="javascript:void(0);">
                            <div class="order">
                                <div class="fl">
                                    <span class="firde">运费&emsp;</span>
    ...
    <div style="line-height: 1.4rem;" class="myorder p">
        <div class="content30">
            <a href="javascript:void(0)">
                <div class="order">
                    <div class="fl">
                        <span class="firde">服务&emsp;</span>
                        <span class="s-description">由商城自营发货并提供售后服务</span>
                    </div>
                </div>
            </a>
        </div>
    ...
    <div class="myorder p tbv">
        <div class="content30">
            <a href="javascript:void(0)">
                <div class="order">
                    <div class="fl">
                        <span class="firde">用户评价<b class="yasan-ajdas">(<?php echo $goods['comment_statistics']['total_sum']; ?>)</b></span>
                    </div>
                    <div class="fr">
                        <span class="deta_eva">好评&nbsp;<i><?php echo $goods['comment_statistics']['high_rate']; ?>%</i></span>
                        <i class="Mright"></i>
                    </div>
                </div>
            </a>
        ...
        <div class="xq_details pl-list01" >
            <div class="spxq-ggcs comment_de p"  style="display:none;">
                <ul>
                    <!--1 全部 2好评 3 中评 4差评-->
                    <li class="pj-list red">全部评价(<?php echo $goods['comment_statistics']['total_sum']; ?>)</li>
                    <li class="pj-list">好评(<?php echo $goods['comment_statistics']['high_sum']; ?>)</li>
                    <li class="pj-list">中评(<?php echo $goods['comment_statistics']['center_sum']; ?>)</li>
                    <li class="pj-list">差评(<?php echo $goods['comment_statistics']['low_sum']; ?>)</li>
                    <li class="pj-list">有图(<?php echo $goods['comment_statistics']['img_sum']; ?>)</li>
                </ul>
            </div>
            <!--评论列表-->
                            ...
                            <a href="<?php echo U('Goods/goodsInfo',array('id'=>$v[goods_id])); ?>">
                                <div class="similer-product">
                                    ...
                                    <span class="similar-product-price">
                                        <span class="big-price"><em>¥</em><?php echo explode_price($v[shop_price],0); ?><em>.<?php echo explode_price($v[shop_price],1); ?></em></span>
                                    </span>
                                </div>
                            </a>
                        </li>
...
<div class="fenxiang-1">
    ...
    <div class="img-wen clearfix">
        <p>分享至</p>
        <?php if(substr($goods['goods_images'][0]['image_url'], 0, strlen('http')) == 'http'): ?>
            <a target="_black" href="http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=http://<?php echo $_SERVER[HTTP_HOST]; ?>/index.php/Mobile/Goods/goodsInfo/id/<?php echo $_GET[id]; ?>&title=<?php echo $goods['goods_name']; ?>&pics=<?php echo $goods['goods_images'][0]['image_url']; ?>">
                <img src="/template/mobile/rainbow/static/images/ico-share-kj.png" alt="">
                <span>qq空间</span>
            </a>
            <a target="_blank" href="http://service.weibo.com/share/share.php?url=http://<?php echo $_SERVER[HTTP_HOST]; ?>/index.php/Mobile/Goods/goodsInfo/id/<?php echo $_GET[id]; ?>&title=<?php echo $goods['goods_name']; ?>&pic=<?php echo $goods['goods_images'][0]['image_url']; ?>">
                <img src="/template/mobile/rainbow/static/images/ico-share-weibo.png" alt="">
                <span>新浪微博</span>
            </a>
            <?php else: ?>
            <a href="http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=http://<?php echo $_SERVER[HTTP_HOST]; ?>/index.php/Mobile/Goods/goodsInfo/id/<?php echo $_GET[id]; ?>&title=<?php echo $goods['goods_name']; ?>&pics=http://<?php echo $_SERVER[HTTP_HOST]; ?><?php echo $goods['goods_images'][0]['image_url']; ?>">
                <img src="/template/mobile/rainbow/static/images/ico-share-kj.png" alt="">
                <span>qq空间</span>
            </a>
            <a href="http://service.weibo.com/share/share.php?url=http://<?php echo $_SERVER[HTTP_HOST]; ?>/index.php/Mobile/Goods/goodsInfo/id/<?php echo $_GET[id]; ?>&title=<?php echo $goods['goods_name']; ?>&pic=http://<?php echo $_SERVER[HTTP_HOST]; ?><?php echo $goods['goods_images'][0]['image_url']; ?>">
                <img src="/template/mobile/rainbow/static/images/ico-share-weibo.png" alt="">
                <span>新浪微博</span>
            </a>
        <?php endif; ?>
...
<!--评论列表-s-->
<div id="comments" class="xq_details pl-list01" >
    <div class="spxq-ggcs comment_de p"  style="display:none;">
        <ul>
            <!--1 全部 2好评 3 中评 4差评-->
            <li class="pj-list red">全部评价(<?php echo $goods['comment_statistics']['total_sum']; ?>)</li>
        ...
        <div class="fl">
            <ul style="padding: 0 .3rem;">
                ...
                <li class="keep fr">
                    <a href="javascript:collect_goods(<?php echo $goods['goods_id']; ?>);" id="favorite_add">
                        <i class=" <?php if($collect > 0): ?>red<?php endif; ?>"></i>
                        <p style="white-space:nowrap;">收藏</p>
                    </a>
                </li>
                <li style="padding-right: .6rem;">
...
<form name="buy_goods_form" method="post" id="buy_goods_form">
    ...
    <input type="hidden" name="prom_type" value="<?php echo $goods['prom_type']; ?>"/><!-- 适用砍价活动类型 -->
    ...
    <div class="choose_shop_aready p">
        ...
        <div class="shop-top-under p">
            <div class="maleri30">
                <div class="shopprice">
                    <div class="img_or fl"><img id="zoomimg" src="https://www.hetungugu.com/<?php echo $goods['original_img']; ?>"></div>
                    <div class="fon_or fl">
                        ...
                        <div class="price_or" id="goods_price"><em>￥</em><span><?php echo $goods['shop_price']; ?></span><em></em></div>
                        <div class="dqkc_or"><span>剩余库存：</span><span id="spec_store_count"><?php echo $goods['store_count']; ?></span></div>
                        <?php if($goods[is_virtual] ==1): ?>
                            <div class="dqkc_or buy_limit"><span>限购：</span><span id="buy_limit"><?php echo $goods['virtual_limit']; ?></span></div>
                        <?php endif; ?>
        ...
        <div class="shop-top-under p">
            <div class="maleri30">
                ...
                <?php endforeach; endif; else: echo "" ;endif; ?>
                <div class="shulges p num-count">
                    <span class="pro-num">数量</span>
                    <!--选择数量-->
                    <span class="plus">
...
//    无优惠券时隐藏优惠券模块
   /*$(function(){
        if($("#coupon").children().find(".data-coupon")){
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
    	...
    	if (spec_goods_price.length > 0) {
        	$('#zoomimg').attr('src', spec_goods_price[0].spec_img);
    	}
    });
    var buy_now = $('#buy_now');
    ...
    function buy_button(){
        ...
        if(goods_prom_type == 8 && activity_is_on == 1){
            ...
            var buy_html = "<em style='display: inline-block;margin-top: 17px'>砍价拿</em><em style='margin-top: -.7rem;display: inline-block;margin-top: 17px'>￥"+end_price+"</em>";
            ...
            var join_html = "<em style='display: inline-block;margin-top: 17px'>单独购</em><em style='margin-top: -.7rem;display: inline-block;margin-top: 17px'>￥"+group_by_price+"</em>";
        ...
        buy_now_li.find('.choise_num').css('line-height','2.09rem').html('立即购买');
        buy_now_li.width('50%').show();
        join_cart_li.find('.choise_num').css('line-height','2.09rem').html('加入购物车');
        join_cart_li.show();
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == 1) {
                    ...
                    $('#market_price').html($('input[name="market_price"]').val());
...
//                        surplus_store_count
    ...
    function collect_goods(goods_id){
        $.ajax({
            ...
            success: function(data){
                ...
                if(data.status == 1){
                    //收藏点亮
                    $('.podee .keep').find('i').addClass('red');
                }else if(2 == data.status){
                    $('.podee .keep').find('i').removeClass('red');
                }
            }
        });
    }
    ...
    $('.choise_num_s').click(function () {
        ...
        $('#join_cart').addClass('buy-public')
        $('#buy_now').addClass('buy-public')
    })
    ...
    $('.choise_num').click(function () {
       ...
       var id = $(this).parent().attr('id');
        ...
        cover();
        // $('.choose_shop_aready').show();
        $('.choose_shop_aready').slideToggle('fast')
        $('.podee').hide();
        initGoodsPrice() //初始化，避免不可用的规格显示可用
    })
    ...
    $('.xxgro').click(function () {
        ...
        $('.podee').show();
        sel();
        $('#join_cart').removeClass('buy-public')
        $('#buy_now').removeClass('buy-public')
    })
    /**
     * 顶部导航切换
     */
    ...
    function setNormalGoodsPrice() {
        ...
        if(exchange_integral > 0){
            ...
            $("#price").html("<em>￥</em>" + parseFloat(goods_price).toFixed(2).split('.')[0] + '.<em>' + parseFloat(goods_price).toFixed(2).slice(-2) + '</em>'); //变动价格显示
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if(data.status == 1){
                            ...
                            location.href = "<?php echo U('Bargain/index'); ?>"+url;
