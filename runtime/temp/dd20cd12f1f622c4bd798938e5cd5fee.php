<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"./application/admin/view/system\navigationList.html";i:1568702273;s:76:"D:\phpStudy\PHPTutorial\WWW\tpshop\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <div class="fbutton"> <a href="<?php echo U('Admin/System/addEditNav'); ?>"><div class="add" title="新增导航"><span><i class="fa fa-plus"></i>新增导航</span></div></a> </div>
        ...
        <div class="bDiv" style="height: auto;">
            <div id="flexigrid" cellpadding="0" cellspacing="0" border="0" data-url="<?php echo U('admin/System/delNavigations'); ?>">
                <table>
                    <tbody>
                        ...
                        <tr data-id="<?php echo $vo[id]; ?>">
                            ...
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <?php if($vo['url'] != NULL): ?>
                                        <a class="btn blue"  target="_blank" href="<?php echo $vo['url']; ?>">查看</a>
                                    <?php endif; ?>
                                    <a class="btn red" href="<?php echo U('System/delNav',array('id'=>$vo['id'])); ?>">删除</a>
                                    <a href="<?php echo U('Admin/System/addEditNav',array('id'=>$vo['id'])); ?>" class="btn blue">编辑</a> </div>
                            </td>
