<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"./application/admin/view/distribut\second_users.html";i:1575708193;s:76:"D:\phpStudy\PHPTutorial\WWW\tpshop\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <div class="subject">
                <h3><?php echo $nickname; ?>-下级会员管理</h3>
                <h5>网站系统会员索引与管理</h5>
            </div>
        </div>
    </div>
            ...
            <form class="navbar-form form-inline" method="post"  id="search-form2">
                ...
                <div class="sDiv">
                    ...
                    <div class="sDiv2">
                        ...
                        <input type="button" class="btn" onclick="ajax_get_table('search-form2',1,<?php echo $first_id; ?>)" value="搜索">
                    </div>
                </div>
            </form>
        </div>
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">下级会员数</div>
                        </th>
                        <th align="center" axis="col6" class="">
                        ...
                        <th align="center" abbr="user_money" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">订单总额</div>
                        </th>
                        <th align="center" abbr="pay_points" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">积分</div>
                        </th>
                        <th align="center" abbr="article_time" axis="col6" class="">
                            <div style="text-align: center; width: 80px;" class="" onClick="sort('is_examine');">审核</div>
                        </th>
...
<script>
    $(document).ready(function(){
        ...
        ajax_get_table('search-form2',1,first_id);
    ...
    // ajax 抓取页面
    function ajax_get_table(tab,page,first_id){
        ...
        $.ajax({
            type : "POST",
            url:"/index.php/Admin/distribut/ajaxsecond_users/p/"+page+"/first_id/"+first_id,//+tab,
