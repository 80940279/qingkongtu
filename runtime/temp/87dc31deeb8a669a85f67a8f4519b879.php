<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/block\form_list.html";i:1568702273;s:76:"D:\phpStudy\PHPTutorial\WWW\tpshop\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
                    ...
                    <div class="sDiv2">
                        <select class="select sDiv3" style="border:none;"  onchange="select_form_config(this)">
                            ...
                            <?php if(is_array($form_config) || $form_config instanceof \think\Collection || $form_config instanceof \think\Paginator): $i = 0; $__LIST__ = $form_config;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo $v['tpl_timeid']; ?>" <?php if($tpl_timeid == $v['tpl_timeid']): endif; ?>><?php echo $v['form_name']; ?></option>
