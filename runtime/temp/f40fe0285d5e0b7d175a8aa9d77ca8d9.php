<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view/block\template_class.html";i:1568702273;s:76:"D:\phpStudy\PHPTutorial\WWW\tpshop\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <form method="post">
    ...
    <div class="flexigrid">
		<div class="mDiv">
        	...
        	<a href="<?php echo U('block/class_info',array('act'=>'add')); ?>"><div class="fbutton"><div class="add" title="新增分类"><span><i class="fa fa-plus"></i>新增行业</span></div></div></a> 
            ...
            <tr nctype="0" class="parent_id_<?php echo $vo[parent_id]; ?>" data-level="<?php echo $vo[level]; ?>"  id="<?php echo $vo['level']; ?>_<?php echo $vo['id']; ?>">
              ...
              <td class="handle">
                <div style="text-align:center;   min-width:150px !important; max-width:inherit !important;">
                  ...
                  <ul>
                     <li><a href="<?php echo U('block/class_info',array('act'=>'edit','id'=>$vo['id'])); ?>">编辑信息</a></li> 

                     <?php if($vo['parent_id'] == 0): ?>          
                     	<li><a href="<?php echo U('block/class_info',array('act'=>'add','parent_id'=>$vo['id'])); ?>">新增信息</a></li>
                     <?php endif; ?>
	                   
                     <li><a href="javascript:void(0)" data-url="<?php echo U('block/class_handle'); ?>" data-id="<?php echo $vo['id']; ?>" onClick="delfun(this)">删除信息</a></li>                                   
                  </ul>
                  </span>
                </div>
              </td>
