<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view/article\agreement.html";i:1568702273;s:76:"D:\phpStudy\PHPTutorial\WWW\tpshop\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="flexigrid">
  <div class="mDiv">
      <div class="ftitle"><h3>列表</h3><h5></h5></div>
    ...
    <?php if(is_array($agreement) || $agreement instanceof \think\Collection || $agreement instanceof \think\Paginator): if( count($agreement)==0 ) : echo "" ;else: foreach($agreement as $key=>$vo): ?>
      <tr>
        ...
        <td class="handle-s">
        	<div style="text-align: center; width: 60px;"><a class="btn blue" href="<?php echo U('Article/edit_agreement',array('doc_id'=>$vo['doc_id'])); ?>">编辑</a></div>
        </td>
