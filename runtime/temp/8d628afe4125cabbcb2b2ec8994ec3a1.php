<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"./application/admin/view/order\virtual_list.html";i:1568702273;s:76:"D:\phpStudy\PHPTutorial\WWW\tpshop\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="flexigrid">
    <div class="mDiv">
      ...
      <div class="fbutton"><a href="javascript:export_order()"><div class="add" title="选定行数据导出excel文件,如果不选中行，将导出列表所有数据"><span><i class="fa fa-plus"></i>导出数据</span></div></a></div>
	  ...
	  <form class="navbar-form form-inline"  method="post" action="<?php echo U('Order/export_order'); ?>"  name="search-form2" id="search-form2">
          ...
          <div class="sDiv">
            ...
            <div class="sDiv2">
                <select name="pay_status" class="select" style="border:none;">
            ...
            <div class="sDiv2">
                <select name="pay_code" class="select" style="border:none;">
