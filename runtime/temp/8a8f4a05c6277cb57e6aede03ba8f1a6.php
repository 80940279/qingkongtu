<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:51:"./application/admin/view/order\ajaxVirtualList.html";i:1568702273;}*/ ?>
<table>
    <tbody>
            ...
            <tr data-order-id="<?php echo $list['order_id']; ?>">
                ...
                <td align="center" axis="col1" class="handle" align="center">
                    <div style="text-align: center; ">
                        <a class="btn green" href="<?php echo U('Order/virtual_info',array('order_id'=>$list['order_id'])); ?>">查看</a>
                    </div>
                </td>
