<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view/user\account_log.html";i:1568702273;s:76:"D:\phpStudy\PHPTutorial\WWW\tpshop\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <div class="fbutton"><a href="<?php echo U('Admin/User/account_edit',array('user_id'=>$user_id)); ?>"><div class="add" title="资金调节"><span><i class="fa fa-plus"></i>资金调节</span></div></a></div>
            <div class="fbutton"><a href="<?php echo U('Admin/User/index'); ?>"><div class="up" title="返回会员列表"><span><i class="fa fa-level-up"></i>返回会员列表</span></div></a></div>
