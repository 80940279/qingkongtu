<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./template/mobile/rainbow/goods\goodsinfotwo.html";i:1576909781;s:79:"D:\phpStudy\PHPTutorial\WWW\tpshop\template\mobile\rainbow\public\wx_share.html";i:1576490065;}*/ ?>
<style>
    .maleri30 {
        overflow: hidden;
    }
    .maleri30 .shulges:nth-child(1) p{
        float: left;
    }
    ...
    <!--选择属性的弹窗-s-->
        ...
        <input type="hidden" name="store_count" value="<?php echo $goods['goods_number']; ?>"/><!-- 活动库存 -->
                ...
                <div class="maleri30">
                    <div class="shopprice">
                        ...
                        <div class="fon_or fl">
                            ...
                            <div class="price_or" id="goods_price"><b><?php echo intval($goods['shop_price']*$exchange_rate); ?>元</b><span>/<?php echo intval($goods['shop_price']); ?>日元</span></div>
                            <div class="dqkc_or"><span>剩余库存：</span><span id="spec_store_count"><?php echo $goods['goods_number']; ?></span></div>
                            ...
                            <div class="shulges p choicsel" >
                                ...
                                <?php if(is_array($spec) || $spec instanceof \think\Collection || $spec instanceof \think\Paginator): if( count($spec)==0 ) : echo "" ;else: foreach($spec as $k2=>$v2): ?>
                                    <div class="plus choic-sel">
                                        <a id="goods_spec_a_<?php echo $v2[item_id]; ?>" title="<?php echo $v2[item]; ?>" onclick="switch_spec(this); <?php if(!empty($v2['src'])): ?>$('#zoomimg').attr('src','<?php echo $v2[src]; ?>');<?php endif; ?>">
        ...
        <div class="btns-fixed-wrap">
            <!--<div class="plusshopcar-buy p btns-fixed-w100">
                <a id="buy_now" class="pb_buy buy_button" href="javascript:void(0);">确定</a>
            </div>-->
            <div class="plusshopcar-buy p btns-fixed-w100">
...
<script type="text/javascript">
    ...
    function setNormalGoodsPrice() {
        ...
        if(exchange_integral > 0){
            ...
            $("#goods_price b").html(parseInt(goods_price*<?php echo $exchange_rate; ?>)+'元'); //变动价格显示
            $("#goods_price span").html('/'+parseInt(goods_price)+'日元'); //变动价格显示
