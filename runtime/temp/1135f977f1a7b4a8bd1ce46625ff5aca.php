<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/goods\brandList.html";i:1568702273;s:76:"D:\phpStudy\PHPTutorial\WWW\tpshop\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="flexigrid">
    <div class="mDiv">
      ...
      <div class="fbutton"><a href="<?php echo U('Admin/Goods/addEditBrand'); ?>"><div class="add" title="新增品牌"><span><i class="fa fa-plus"></i>新增品牌</span></div></a></div>
            ...
            <?php if(is_array($brandList) || $brandList instanceof \think\Collection || $brandList instanceof \think\Paginator): $i = 0; $__LIST__ = $brandList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
              <tr data-id="<?php echo $list[id]; ?>">
                ...
                <td align="left" class="">
                  <div style="text-align: left; width: 100px;">
	                  <a href="<?php echo !empty($list['logo'])?$list['logo']:'/public/images/icon_goods_thumb_empty_300.png'; ?>" target="_blank"><img onMouseOver="layer.tips('<img src=<?php echo $list['logo']; ?>>',this,{tips: [1, '#fff']});" onMouseOut="layer.closeAll();" width="40" height="30" src="<?php echo !empty($list['logo'])?$list['logo']:'/public/images/icon_goods_thumb_empty_300.png'; ?>"/></a>
                  </div>
                </td>
              ...
              <td align="center">
                ...
                <td align="center" class="handle">
                  <div style="text-align: center; width: 100px;">                    
                    <a class="btn red"  href="javascript:void(0)"  onclick="publicHandle('<?php echo $list[id]; ?>','del')" >删除</a>
                    <a href="<?php echo U('Admin/goods/addEditBrand',array('id'=>$list['id'],'p'=>$_GET[p])); ?>" class="btn blue">编辑</a>
                  </div>
                </td>
